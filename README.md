...
For prefix commands you can simply add the dice you need after the bot's prefix + r. So to roll a d6: `?r d6`
...
You can roll multiple dices of the same type: `?r 3d8`
...
Ex: `/advantage_roll d6`, `/advantage_roll d8 3`.
